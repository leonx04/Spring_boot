<%@page language="java" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      <title>Khách hàng | Danh sách khách hàng</title>
     ...
     background-size: cover; ">
      ...
      <div class="container">
        <div class="text-end mt-2">
          <a href="/khach-hang/create" class="btn btn-success">Thêm mới</a>
        </div>
        <div class="border border-1 rounded p-3 mt-2">
          <h2 class="text-center mt-2">Danh sách khách hàng</h2>
          <div class="mt-2">
            <div class="mt-2 w-25">
              <!-- Thêm form tìm kiếm -->
                ...
                <c:forEach items="${data}" var="khachHang" varStatus="items">
                  <tr>
                    ...
                    <td class="text-nowrap">
                      ...
                      <a href="/khach-hang/delete/${khachHang.id}" class="btn btn-danger">Xoá</a>
                    </td>
                  </tr>
                </c:forEach>
              </tbody>
