        ...
        <form action="/khach-hang/update/${data.id}" method="post">
            ...
            <div class="mt-2">
                ...
                <c:if test="${not empty errors['sdt']}">
                    <div class="alert alert-danger mt-2"><small class=" text-center">${errors['sdt']}</small></div>
                </c:if>
            </div>
            ...
            <div class="mt-2">
                ...
                <c:if test="${not empty errors['trangThai']}">
                    <div class="alert alert-danger mt-2"><small class=" text-center">${errors['trangThai']}</small>
                    </div>
                </c:if>
            </div>
