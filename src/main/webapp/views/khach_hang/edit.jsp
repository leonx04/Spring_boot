<%@page language="java" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      <title>Khách hàng | Cập nhật</title>
      ...
      <div class="container d-flex align-items-center justify-content-center mt-4">
        ...
        ">
          ...
          <form action="/khach-hang/update/${data.id}" method="post">
            <h2 class="text-center mt-2">Cập nhật Khách hàng</h2>
            <div class="mt-2">
              <label class="form-lablel">ID Khách hàng</label>
              <input type="text" class="form-control" placeholder="Vui lòng nhập ID Khách hàng" name="id"
                value="${data.id}" disabled />
            </div>

            <div class="mt-2">
              <label class="form-lablel">Mã Khách hàng</label>
              <input type="text" class="form-control" placeholder="Vui lòng nhập mã Khách hàng" name="ma"
                value="${data.ma}" />
            ...
            <div class="mt-2">
              ...
              <input type="text" class="form-control" placeholder="Vui lòng nhập tên Khách hàng" name="ten"
                value="${data.ten}" />
            ...
            <div class="mt-2">
              ...
              <input type="text" class="form-control" placeholder="Vui lòng nhập số điện thoại Khách hàng" name="sdt"
                value="${data.sdt}" />
              <c:if test="${not empty errors['sdt']}">
                <small class="alert alert-danger mt-2 text-center">${errors['sdt']}</small>
              </c:if>
            </div>
