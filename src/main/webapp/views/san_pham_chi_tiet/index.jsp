    ...
    <div class="mt-2">
      ...
      <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center">
          ...
          <li class="page-item ${data.number == 0 ? 'disabled' : ''}">
            <a class="page-link" href="/san-pham-chi-tiet/index?page=1&limit=${data.size}&idSanPham=${idSanPham}" aria-label="First">
              Trang đầu
            </a>
          </li>
          ...
          <li class="page-item ${data.number == data.totalPages - 1 ? 'disabled' : ''}">
            <a class="page-link" href="/san-pham-chi-tiet/index?page=${data.totalPages}&limit=${data.size}&idSanPham=${idSanPham}" aria-label="Last">
              Trang cuối
            </a>
          </li>
          <li class="page-item ${data.number == data.totalPages - 1 ? 'disabled' : ''}">
