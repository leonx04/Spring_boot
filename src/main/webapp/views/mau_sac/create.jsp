...
<head>
    <title>Màu sắc | Thêm mới</title>
...
<div class="container d-flex align-items-center justify-content-center vh-100">
    <div class="login-container p-2 boder-1 rounded-3" style="
        ...
        <form action="store" method="post">
            <h2 class="text-center mt-2">Thêm mới màu sắc</h2>
            <div class="mt-2">
                <label class="form-lablel">Mã màu sắc</label>
                <input type="text" class="form-control" placeholder="Vui lòng nhập mã màu sắc" name="ma" value="${data.ma}"/>
            </div>
            ...
            <div class="mt-2">
                ...
                <input type="text" class="form-control" placeholder="Vui lòng nhập tên màu sắc" name="ten" value="${data.ten}" />
            </div>
            ...
            <div class="mt-2">
                ...
                <select class="form-control" name="trangThai" >
                    <option value="1">Hoạt động</option>
                    <option value="0">Không hoạt động</option>
                </select>
            </div>
